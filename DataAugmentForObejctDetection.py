...
class DataAugmentForObjectDetection():
    ...
    def _crop_img_bboxes(self, img, bboxes):
        ...
        for bbox in bboxes:
            ...
            crop_bboxes.append([
                bbox[0] - crop_x_min, bbox[1] - crop_y_min,
    ...
    def _shift_pic_bboxes(self, img, bboxes):
        ...
        M = np.float32([[1, 0, x],
                        [0, 1,
                         y]])  #x为向左或右移动的像素值,正为向右负为向左; y为向上或者向下移动的像素值,正为向下负为向上
    ...
    def dataAugment_fixed(self, img, bboxes):
        '''
...
if __name__ == '__main__':
    ...
    source_pic_root_path = 'D:/train/images'

    source_xml_root_path = 'D:/train/labels'
        ...
        for file in files:
            ...
            while cnt < need_aug_num:
                ...
                if os.path.splitext(file)[1] == '.jpg':
                    ...
                    txt_path = os.path.join(source_xml_root_path,
                ...
                auged_img, auged_bboxes = dataAug.dataAugment_fixed(img, bboxes)
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        ...
        for file in files:
            ...
            while cnt < need_aug_num:
                ...
                xml_path = os.path.join(source_xml_root_path,
                                        file[:-4] + '.xml')

                coords = parse_xml(
                    xml_path)  #解析得到box信息，格式为[[x_min,y_min,x_max,y_max,name]]
